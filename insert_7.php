...
$scanned_directory = scandir('img/7/'); //ПОЛУЧАЕМ МАССИВ ПОДПАПОК В КОРНЕВОЙ ПАПКЕ
...
echo json_encode(getDirContents('img/7/' . $scanned_directory[$key] . '/'), JSON_UNESCAPED_UNICODE);
