...
$scanned_directory = scandir('img/6/'); //ПОЛУЧАЕМ МАССИВ ПОДПАПОК В КОРНЕВОЙ ПАПКЕ
...
echo json_encode(getDirContents('img/6/' . $scanned_directory[$key] . '/'), JSON_UNESCAPED_UNICODE);
