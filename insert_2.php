...
$scanned_directory = scandir('img/2/'); //ПОЛУЧАЕМ МАССИВ ПОДПАПОК В КОРНЕВОЙ ПАПКЕ
...
echo json_encode(getDirContents('img/2/' . $scanned_directory[$key] . '/'), JSON_UNESCAPED_UNICODE);
