...
$scanned_directory = scandir('img/8/'); //ПОЛУЧАЕМ МАССИВ ПОДПАПОК В КОРНЕВОЙ ПАПКЕ
...
echo json_encode(getDirContents('img/8/' . $scanned_directory[$key] . '/'), JSON_UNESCAPED_UNICODE);
