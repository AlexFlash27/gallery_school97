...
$scanned_directory = scandir('img/1/'); //ПОЛУЧАЕМ МАССИВ ПОДПАПОК В КОРНЕВОЙ ПАПКЕ
...
echo json_encode(getDirContents('img/1/' . $scanned_directory[$key] . '/'), JSON_UNESCAPED_UNICODE);
