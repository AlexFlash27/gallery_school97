...
$scanned_directory = scandir('img/4/'); //ПОЛУЧАЕМ МАССИВ ПОДПАПОК В КОРНЕВОЙ ПАПКЕ
...
echo json_encode(getDirContents('img/4/' . $scanned_directory[$key] . '/'), JSON_UNESCAPED_UNICODE);
